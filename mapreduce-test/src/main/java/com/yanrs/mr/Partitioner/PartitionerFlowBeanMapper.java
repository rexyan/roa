 ...
 */
public class PartitionerFlowBeanMapper extends Mapper<LongWritable, Text, Text, PartitionerFlowBean>{
    private Text outKey = new Text();
    private PartitionerFlowBean flowBean = new PartitionerFlowBean();
